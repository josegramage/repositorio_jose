...
public class AutocompleteJComboBox_J extends JComboBox{
    private final Searchable_J<String,String> searchable;

    public AutocompleteJComboBox_J(Searchable_J<String,String> s){
	super();
	this.searchable = s;
